export const content = {
  ...
  about_us: {
    ...
    our_values_artisanal_title: `Artisanal`,
    our_values_artisanal_description: `Artisanal`,
    our_values_local_title: `Local`,
    our_values_local_description: `Local`,
    our_values_quality_title: `Quality`,
    our_values_quality_description: `Quality`,
  },
  products: {
    ...
    flavored_honey: `Elevate your taste experience with our selection of flavored honeys, infused with delicious ingredients like lavender, cinnamon, and ginger. Perfect for adding a touch of gourmet flair to your favorite dishes and beverages.`,
    specialty_honey: `Explore our lineup of specialty honeys, including rare varietals like Manuka and Acacia, prized for their unique flavors and medicinal properties. Treat yourself to the luxury of premium honey sourced from the finest locations around the world.`,
    end: `At Kinil Kab, we're passionate about bees, honey, and the incredible benefits they bring to our lives. Join us in celebrating the magic of the hive and experience the joy of pure, unadulterated honey like never before.`
  },
  social_networks: {
    title: `Our socials`
  }
